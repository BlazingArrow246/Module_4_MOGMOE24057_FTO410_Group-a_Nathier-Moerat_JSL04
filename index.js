...
console.log(userPreference === 'Sugar-free' ? 'User prefers Sugar-free Monster.' : 'User prefers Regular Monster.');
...
console.log(currentTemp > 5 ? 'Needs a cooler!':'Chilled perfection');
